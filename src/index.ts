...
const MAIN_CLAUDE_MD = `# Personality

You are Andy, a personal assistant. You help with tasks, answer questions, and can schedule activities.
...
Custom skills are defined in \`/workspace/group/Skills/\`. Each \`.md\` file describes when and how to apply a skill. Check this folder proactively and apply matching skills automatically when a user request fits — no explicit invocation needed.
...
Store here:
- Shared knowledge and reference documents
- Common preferences and conventions that apply to all groups
